...
const referent = _.shuffle([1,1,1,1,1,1])
const picture = _.shuffle([1,1,1,1,1,1])
...
const items = {
  dogs1: [
    {referent: ["dog", "doberman", "one"],
     ...
     picture: [{pic: "ref-utility/dog-parade-basic.png", adj: "big ", condition: "basic"}, {pic: "ref-utility/doberman-5-6.png", adj: "big ", condition: "congr"}, {pic: "ref-utility/dog-parade-doberman.png", adj: "small", condition: "incongr"}],
  ...
  dogs2: [
    {referent: ["dog", "great dane", "one"],
     utterance1: utterance.utterance1b,
     utterance2: utterance.utterance2b,
     picture: [{pic: "ref-utility/dog-parade-basic2.png", adj: "big ", condition: "basic"}, {pic: "ref-utility/great-danes-5-6.png", adj: "big ", condition: "congr"}, {pic: "ref-utility/dog-parade-great-dane.png", adj: "small", condition: "incongr"}],
     target: "warmup/great-dane.png"

   },
   {referent: ["dog", "pug", "one"],
    utterance1: utterance.utterance1s,
    utterance2: utterance.utterance2s,
    picture: [{pic: "ref-utility/dog-parade-basic2.png", adj: "small ", condition: "basic"}, {pic: "ref-utility/pugs-5-6.png", adj: "small ", condition: "congr"}, {pic: "ref-utility/dog-parade-pug.png", adj: "big", condition: "incongr"}],
    target: "warmup/pug.png"
   }
  ],
  birds: [
    {referent: ["bird", "eagle", "one"],
     utterance1: utterance.utterance1b,
     utterance2: utterance.utterance2b,
     picture: [{pic: "ref-utility/bird-parade-basic.png", adj: "big ", condition: "basic"}, {pic: "ref-utility/eagles-5-6.png", adj: "big ", condition: "congr"}, {pic: "ref-utility/bird-parade-eagle.png", adj: "small", condition: "incongr"}],
     target: "warmup/eagle.png"
   },
   {referent: ["bird", "hummingbird", "one"],
    utterance1: utterance.utterance1s,
    utterance2: utterance.utterance2s,
    picture: [{pic: "ref-utility/bird-parade-basic.png", adj: "small ", condition: "basic"}, {pic: "ref-utility/hummingbirds-5-6.png", adj: "small ", condition: "congr"}, {pic: "ref-utility/bird-parade-hummingbird.png", adj: "big", condition: "incongr"}],
    target: "warmup/hummingbird.png"
   }
  ],
  fish: [
    {referent: ["fish", "swordfish", "one"],
     utterance1: utterance.utterance1b,
     utterance2: utterance.utterance2b,
     picture: [{pic: "ref-utility/fish-parade-basic.png", adj: "big ", condition: "basic"}, {pic: "ref-utility/swordfish-5-6.png", adj: "big ", condition: "congr"}, {pic: "ref-utility/fish-parade-swordfish.png", adj: "small", condition: "incongr"}],
     target: "warmup/swordfish.png"

   },
   {referent: ["fish", "goldfish", "one"],
    utterance1: utterance.utterance1s,
    utterance2: utterance.utterance2s,
    picture: [{pic: "ref-utility/fish-parade-basic.png", adj: "small ", condition: "basic"}, {pic: "ref-utility/goldfish-5-6.png", adj: "small ", condition: "congr"}, {pic: "ref-utility/fish-parade-goldfish.png", adj: "big", condition: "incongr"}],
  ...
  {referent: ["flower", "sunflower", "one"],
   utterance1: utterance.utterance1b,
   utterance2: utterance.utterance2b,
   picture: [{pic: "ref-utility/flower-parade-basic.png", adj: "big ", condition: "basic"}, {pic: "ref-utility/sunflowers-5-6.png", adj: "big ", condition: "congr"}, {pic: "ref-utility/flower-parade-sunflower.png", adj: "small", condition: "incongr"}],
 ...
 {referent: ["flower", "dandelion", "one"],
  utterance1: utterance.utterance1s,
  utterance2: utterance.utterance2s,
  picture: [{pic: "ref-utility/flower-parade-basic.png", adj: "small ", condition: "basic"}, {pic: "ref-utility/dandelions-5-6.png", adj: "small ", condition: "congr"}, {pic: "ref-utility/flower-parade-dandelion.png", adj: "big", condition: "incongr"}],
  adj: "small",
  target: "warmup/dandelion.png"
 }],
  trees: [
    {referent: ["tree", "redwood", "one"],
     utterance1: utterance.utterance1b,
     utterance2: utterance.utterance2b,
     picture: [{pic: "ref-utility/tree-parade-basic.png", adj: "big ", condition: "basic"}, {pic: "ref-utility/redwoods-5-6.png", adj: "big ", condition: "congr"}, {pic: "ref-utility/tree-parade-redwood.png", adj: "small", condition: "incongr"}],
     adj: "big",
     target: "warmup/redwood.png"
   },
   {referent: ["tree", "bonsai", "one"],
    utterance1: utterance.utterance1s,
    utterance2: utterance.utterance2s,
    picture: [{pic: "ref-utility/tree-parade-basic.png", adj: "small ", condition: "basic"}, {pic: "ref-utility/bonsais-5-6.png", adj: "small ", condition: "congr"}, {pic: "ref-utility/tree-parade-bonsai.png", adj: "big", condition: "incongr"}],
    adj: "small",
    target: "warmup/bonsai.png"
   }
  ]
}
...
const main_trials = {
    ...
    dogs1:   {
            ...
            utterance: "Your friend says: <br/><b>" + items.dogs1[target_size[0]].utterance1 + items.dogs1[target_size[0]].picture[picture[0]].adj + items.dogs1[target_size[0]].referent[referent[0]] + items.dogs1[target_size[0]].utterance2 + ".</b>",
            ref_spec: referent[0],
    ...
    dogs2:    {
            ...
            utterance: "Your friend says: <br/><b>" + items.dogs2[target_size[1]].utterance1 + items.dogs2[target_size[1]].picture[picture[1]].adj + items.dogs2[target_size[1]].referent[referent[1]] + items.dogs2[target_size[1]].utterance2 + ".</b>",
            ref_spec: referent[1],
            question:  "What do you think your friend meant?",
    ...
    birds:    {
            ...
            utterance: "Your friend says: <br/><b>" + items.birds[target_size[2]].utterance1 + items.birds[target_size[2]].picture[picture[2]].adj + items.birds[target_size[2]].referent[referent[2]] + items.birds[target_size[2]].utterance2 + ".</b>",
            ref_spec: referent[2],
            question:  "What do you think your friend meant?",
  ...
  fish:      {
            ...
            utterance: "Your friend says: <br/><b>" + items.fish[target_size[3]].utterance1 + items.fish[target_size[3]].picture[picture[3]].adj + items.fish[target_size[3]].referent[referent[3]] + items.fish[target_size[3]].utterance2 + ".</b>",
            ref_spec: referent[3],
            question:  "What do you think your friend meant?",
  ...
  flowers:      {
            ...
            utterance: "Your friend says: <br/><b>" + items.flowers[target_size[4]].utterance1 + items.flowers[target_size[4]].picture[picture[4]].adj + items.flowers[target_size[4]].referent[referent[4]] + items.flowers[target_size[4]].utterance2 + ".</b>",
            ref_spec: referent[4],
            question:  "What do you think your friend meant?",
    ...
    trees:    {
            ...
            utterance: "Your friend says: <br/><b>" + items.trees[target_size[5]].utterance1 + items.trees[target_size[5]].picture[picture[5]].adj + items.trees[target_size[5]].referent[referent[5]] + items.trees[target_size[5]].utterance2 + ".</b>",
            ref_spec: referent[5],
            question:  "What do you think your friend meant?",
...
const warmup_trials = {dogs1: {
  ...
  picture2: "warmup/doberman_warmup.png",
  correct1: ["chihuahua"],
  correct2: ["doberman"],
  correct3: ["dogs"],
...
flowers: {
  ...
  picture2: "warmup/sunflower_warmup.png",
  correct1: ["dandelion"],
  correct2: ["sunflower"],
  correct3: ["flowers"],
  text: "Please label the pictures below.",
...
fish: {
  ...
  picture2: "warmup/goldfish_warmup.png",
  correct1: ["swordfish"],
  correct2: ["goldfish"],
  correct3: ["fish"],
  text: "Please label the pictures below.",
