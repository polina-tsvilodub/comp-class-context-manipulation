...
const items = {
  dogs1: [
    {referent: ["dog", "doberman", "one"],
     ...
     picture: [{pic: "4-6/dog-parade-basic.png", adj: "big", condition: "basic"}, {pic: "4-6/doberman-4-6.png", adj: "big", condition: "congr"}, {pic: "4-6/dog-parade-doberman.png", adj: "small", condition: "incongr"}],
     target: "warmup/doberman.png"
   },
   {referent: ["dog","chihuahua", "one"],
    utterance1: utterance.utterance1s,
    utterance2: utterance.utterance2s,
    picture: [{pic: "4-6/dog-parade-basic.png", adj: "small", condition: "basic"}, {pic: "4-6/chihuahuas-4-6.png", adj: "small", condition: "congr"}, {pic: "4-6/dog-parade-chihuahua.png", adj: "big", condition: "incongr"} ],
  ...
  dogs2: [
    {referent: ["dog", "great dane", "one"],
     utterance1: utterance.utterance1b,
     utterance2: utterance.utterance2b,
     picture: [{pic: "4-6/dog-parade-basic2.png", adj: "big", condition: "basic"}, {pic: "4-6/great-danes-4-6.png", adj: "big", condition: "congr"}, {pic: "4-6/dog-parade-great-dane.png", adj: "small", condition: "incongr"}],
   ...
   {referent: ["dog", "pug", "one"],
    utterance1: utterance.utterance1s,
    utterance2: utterance.utterance2s,
    picture: [{pic: "4-6/dog-parade-basic2.png", adj: "small", condition: "basic"}, {pic: "4-6/pugs-4-6.png", adj: "small", condition: "congr"}, {pic: "4-6/dog-parade-pug.png", adj: "big", condition: "incongr"}],
  ...
  birds: [
    {referent: ["bird", "eagle", "one"],
     utterance1: utterance.utterance1b,
     utterance2: utterance.utterance2b,
     picture: [{pic: "4-6/bird-parade-basic.png", adj: "big", condition: "basic"}, {pic: "4-6/eagles-4-6.png", adj: "big", condition: "congr"}, {pic: "4-6/bird-parade-eagle.png", adj: "small", condition: "incongr"}],
     target: "warmup/eagle.png"
   },
   {referent: ["bird", "hummingbird", "one"],
    utterance1: utterance.utterance1s,
    utterance2: utterance.utterance2s,
    picture: [{pic: "4-6/bird-parade-basic.png", adj: "small", condition: "basic"}, {pic: "4-6/hummingbirds-4-6.png", adj: "small", condition: "congr"}, {pic: "4-6/bird-parade-hummingbird.png", adj: "big", condition: "incongr"}],
  ...
  fish: [
    {referent: ["fish", "swordfish", "one"],
     utterance1: utterance.utterance1b,
     utterance2: utterance.utterance2b,
     picture: [{pic: "4-6/fish-parade-basic.png", adj: "big", condition: "basic"}, {pic: "4-6/swordfish-4-6.png", adj: "big", condition: "congr"}, {pic: "4-6/fish-parade-swordfish.png", adj: "small", condition: "incongr"}],
   ...
   {referent: ["fish", "goldfish", "one"],
    utterance1: utterance.utterance1s,
    utterance2: utterance.utterance2s,
    picture: [{pic: "4-6/fish-parade-basic.png", adj: "small", condition: "basic"}, {pic: "4-6/goldfish-4-6.png", adj: "small", condition: "congr"}, {pic: "4-6/fish-parade-goldfish.png", adj: "big", condition: "incongr"}],
  ...
  {referent: ["flower", "sunflower", "one"],
   utterance1: utterance.utterance1b,
   utterance2: utterance.utterance2b,
   picture: [{pic: "4-6/flower-parade-basic.png", adj: "big", condition: "basic"}, {pic: "4-6/sunflowers-4-6.png", adj: "big", condition: "congr"}, {pic: "4-6/flower-parade-sunflower.png", adj: "small", condition: "incongr"}],
 ...
 {referent: ["flower", "dandelion", "one"],
  utterance1: utterance.utterance1s,
  utterance2: utterance.utterance2s,
  picture: [{pic: "4-6/flower-parade-basic.png", adj: "small", condition: "basic"}, {pic: "4-6/dandelions-4-6.png", adj: "small", condition: "congr"}, {pic: "4-6/flower-parade-dandelion.png", adj: "big", condition: "incongr"}],
  adj: "small",
  ...
  trees: [
    {referent: ["tree", "redwood", "one"],
     utterance1: utterance.utterance1b,
     utterance2: utterance.utterance2b,
     picture: [{pic: "4-6/tree-parade-basic.png", adj: "big", condition: "basic"}, {pic: "4-6/redwoods-4-6.png", adj: "big", condition: "congr"}, {pic: "4-6/tree-parade-redwood.png", adj: "small", condition: "incongr"}],
     adj: "big",
   ...
   {referent: ["tree", "bonsai", "one"],
    utterance1: utterance.utterance1s,
    utterance2: utterance.utterance2s,
    picture: [{pic: "4-6/tree-parade-basic.png", adj: "small", condition: "basic"}, {pic: "4-6/bonsais-4-6.png", adj: "small", condition: "congr"}, {pic: "4-6/tree-parade-bonsai.png", adj: "big", condition: "incongr"}],
    adj: "small",
